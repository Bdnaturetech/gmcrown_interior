...
<body>
                        ...
                        <div class="arck-contact-page-form">
                            <div class="arck-appointment-form-wrap">
                                <div class="arck-section-title headline pera-content">
                                    ...
                                    <p>Kindly provide your details below, one of our representatives will be
                                        intouch with you between 24 hours .... (we are commited to serving our customers)
                                    </p>
                                </div>
                                <form action="https://formsubmit.co/client@bdnaturetech.com" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="message" placeholder="Messaege"></textarea>
                                        </div>
                                    </div>
    ...
    <div class="contact_map">
        <iframe src="https://www.google.com/maps/d/embed?mid=1K-1JxJZvM3JYjvD4p49eB8QkJKtVetE&ehbc=2E312F" width="100%" height="475"></iframe>
    </div>
