...
<html lang="en">
    <head>
        ...
        <meta content="Thank you page" name="Thank you for submiting enquiry with gm crown interior">
    ...
    <body>
        <nav class="navigation">
            <a href="https://gmcrowninterior.com" style rel="nofollow" target="_blank">
               <h1 style="color:white;">GM Crown Interior</h1>
            </a>
        </nav>
        <div class="content">
            ...
            <div class="link-container">
                <a 
                    class=link
                    href="https://gmcrowninterior.com"
                    rel="nofollow"
                    target="_blank"
                >
                    Go back to GM crown Interior website? 
                ...
                <a 
                    ...
                    target="_blank"
                >
                    Contact our representative on whatsapp?
                    <svg class="ic-launch" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path 
                            fill-rule="evenodd" 
                            clip-rule="evenodd" 
