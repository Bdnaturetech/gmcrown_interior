		...
		<div class="container">
			<div class="header-top-content d-flex justify-content-between position-relative">
				...
				<div class="brand-logo">
					<a href="/"><img src="assets/img/logo/logo.png" alt="gm crown interior "></a>
				</div>
				...
				<div class="header-cta-btn-wrapper d-flex align-items-center">
					<div class="header-cta-number d-flex align-items-center text-uppercase">
						...
						<div class="header-cta-value">
							...
							<span class="ar-value">+234 802 855 7665</span>
						</div>
					</div>
					<div class="header-cta-btn">
						<a class="d-flex justify-content-center align-items-center" href="contact">Get Quote Now <i class="fal fa-long-arrow-right"></i></a>
					</div>
				</div>
					...
					<div class="sidebar-info-contents headline pera-content">
						<div class="content-inner">
							...
							<div class="content-box">
								<h5>About Us</h5>
								<p class="text">At GM Crown Interior, we believe that every space deserves to be adorned with elegance and style. Our expert team is dedicated to transforming your vision into reality, whether it's revamping a single room or designing a cohesive interior scheme for your entire home.</p>
							</div>
